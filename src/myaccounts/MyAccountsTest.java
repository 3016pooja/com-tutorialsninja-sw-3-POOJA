...
public class MyAccountsTest extends Utiltiy {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("input-firstname"), "dina");
        //3.4 Enter Last Name
        sendTextToElement(By.id("input-lastname"), "wadgama");
        //3.5 Enter Email
        sendTextToElement(By.id("input-email"), "jasushaha123@gmail.com");
        //3.6 Enter Telephone
        sendTextToElement(By.id("input-telephone"), "987658741");
        //3.7 Enter Password
