...
public class LaptopsAndNotebooksTest extends Utiltiy {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("input-payment-firstname"), "Raha");
        sendTextToElement(By.id("input-payment-lastname"), "kapoor");
        sendTextToElement(By.id("input-payment-email"), "elizbeth123@gmail.com");
        sendTextToElement(By.id("input-payment-telephone"), "78594561133");
        sendTextToElement(By.id("input-payment-address-1"), "downing street");
        sendTextToElement(By.id("input-payment-city"), "London");
        sendTextToElement(By.id("input-payment-postcode"), "ha3 8pe");
